Indonesia.provinces.each do |province|
	...
	Rails.logger.info("-----province #{idn_province} created!")
	# puts("-----province #{idn_province} created!")
		...
		cities.each do |city|
			...
			Rails.logger.info("-----city #{idn_city} created!")
			...
			districts.each do |district|
				...
				Rails.logger.info("-----district #{idn_district} created!")
				...
				villages.each do |village|
					...
					Rails.logger.info("-----village #{idn_village} created!")
